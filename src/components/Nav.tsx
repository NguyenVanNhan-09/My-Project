...
const Nav = ({ keyword = [], keyMain }: Props) => {
    return (
        <>
            <nav aria-label='Breadcrumb' className=' flex items-center py-6 bg-[#FDFDFD]'>
                <ol className='flex items-center gap-1 text-sm text-gray-600 ml-[110px] mr-[110px]'>
                    ...
                    <li>
                        <div className='block transition hover:text-gray-700'>{keyMain}</div>
                    </li>
                    ...
                    {keyword.map((item, index) => (
                        <div key={index} className='flex items-center'>
                            <li>
                                <div className='block transition hover:text-gray-700'>{item}</div>
                            </li>
