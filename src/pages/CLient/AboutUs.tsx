            ...
            <div className=''>
                            ...
                            <div className='lg:pr-24 flex items-center'>
                                <div className='data w-full'>
                                    ...
                                    <p className='font-normal text-xl leading-8 text-gray-500 max-lg:text-center max-w-2xl mx-auto'>
                                        ...
                                        philosophy. We go beyond aesthetics, prioritizing accessibility, scalability,
                                        and usability. Every element, from the tiniest detail to the grandest layout, is
                ...
                <section className=' py-14 lg:py-24 bg-gray-50'>
                    <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative'>
                        ...
                        <div className='text-white swiper mySwiper2'>
                                    ...
                                    <div className='relative mb-20'>
                                        ...
                                        <div className='max-w-max mx-auto lg:max-w-4xl'>
                                            <p className='text-lg text-gray-500 leading-8 mb-8 text-center'>
                                                I have been using pagedone for several months now, and I must say that
                                                it has made my life a lot easier. The platform's intuitive interface and
                                                ease of use have allowed me to manage my finances more effectively and
                                                make informed investment decisions. I particularly like the product's
                                    ...
                                    <div className='group w-full flex-wrap flex items-center gap-8  transition-all duration-500 p-8  lg:flex-nowrap'>
                                        ...
                                        <div className='text-center lg:text-left lg:max-w-xs flex-1'>
                                            ...
                                            <p className='text-gray-500 leading-6 mb-7'>
                                                I am the co founder of pagedone and we’ve pushed our limit so far to
                                                make it successful.
                                            </p>
                                ...
                                <div className='col-span-1'>
                                    <div className='group w-full flex-wrap flex items-center gap-8 flex-col md:flex-row transition-all duration-500 p-8 lg:flex-nowrap'>
                                        ...
                                        <div className='text-center lg:text-left lg:max-w-xs flex-1 flex flex-col justify-between'>
                                            ...
                                            <p className='text-gray-500 leading-6 mb-7'>
                                                I’ve been lead designer for pagedone since the beginning of it and
                                                enjoyed every bit.
                                            </p>
                ...
                <section>
                    <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
                        <div className='bg-white rounded-2xl p-8 xl:p-11'>
                            <h2 className='font-manrope text-4xl text-[#205a79] text-center font-bold mb-4'>
                                Subscribe to the latest offer
                            </h2>
                            <p className='text-slate-500 text-center mb-11 max-lg:max-w-2xl mx-auto'>
