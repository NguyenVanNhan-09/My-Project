            ...
            <div className='p-6'>
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6'>
                    <div className='bg-white rounded-md border border-gray-100 p-6 shadow-md shadow-black/5'>
                        <div className='flex justify-between mb-6'>
                            <div>
                                <div className='flex items-center mb-1'>
                                    <div className='text-2xl font-semibold'>{usersLength}</div>
                                </div>
                        ...
                        <Link to={`/admin/users`} className='text-[#f84525] font-medium text-sm hover:text-red-800'>
                            View
                        </Link>
                    </div>
                    <div className='bg-white rounded-md border border-gray-100 p-6 shadow-md shadow-black/5'>
                        <div className='flex justify-between mb-4'>
                            <div>
                                <div className='flex items-center mb-1'>
                                    <div className='text-2xl font-semibold'>{productsLength}</div>
                        ...
                        <Link to={`/admin/products`} className='text-[#f84525] font-medium text-sm hover:text-red-800'>
                            View
                        </Link>
                    </div>
                    <div className='bg-white rounded-md border border-gray-100 p-6 shadow-md shadow-black/5'>
                                                ...
                                                <div className='flex items-center'>
                                                    ...
                                                    <div className='relative w-full'>
                                                        <div className='overflow-hidden h-2 text-xs flex rounded bg-red-200'>
                                                            <div className='w-[45%] shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-red-500'></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
